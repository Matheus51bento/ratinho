...
maze_lines = maze_file.readlines()[1:]
...
while walking:
    ...
    if labirinto[posicao_atual.x - 1][posicao_atual.y]['color'] in ['pink', 'yellow']:
        walking = end_game(posicao_atual.x - 1, posicao_atual.y)
        labirinto[posicao_atual.x][posicao_atual.y]['color'] = 'green'

    elif labirinto[posicao_atual.x + 1][posicao_atual.y]['color'] in ['pink', 'yellow']:
        walking = end_game(posicao_atual.x + 1, posicao_atual.y)
        labirinto[posicao_atual.x][posicao_atual.y]['color'] = 'green'

    elif labirinto[posicao_atual.x][posicao_atual.y - 1]['color'] in ['pink', 'yellow']:
